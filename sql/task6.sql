...
create index idx_vac_id on response(vacancy_id);-- В теории оно может ускорить, но либо я мало значений ввел и у меня
-- что он есть, что его нету разницы отсутствует
